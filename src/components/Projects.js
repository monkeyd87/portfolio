...
const progectitems =  projects.map(project=><Card className='col-3 m-3' title={project.title} tech={project.technologies_used} img={project.img||img} github={project.github_link} url={project.deployed_link}/>)
